...
Here is the full script to get a fully functionnal node with more than 10k tweets about Devoxx France.
...
Nota : this script does not creat the river to fetch new tweets. Refer to the first section if you want to do it.

h1. Thanks

Thanks to "Fran�ois Descamps":https://twitter.com/#!/descampsf for his help
